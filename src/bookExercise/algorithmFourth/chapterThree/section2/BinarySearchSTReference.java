 ...
 */
public class BinarySearchSTReference<Key extends Comparable<Key>, Value> {
     ...
     */
    public BinarySearchSTReference() {
        this(INIT_CAPACITY);
    }
     ...
     */
    public BinarySearchSTReference(int capacity) {
...
//    }
    ...
    public static void main(String[] args) {
        BinarySearchSTReference<String, Integer> st = new BinarySearchSTReference<String, Integer>();
